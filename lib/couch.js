...
/**
* The initial configuration would be something simple like {host:<>,host:<>}
* We simply use this class to interact with couchdb i.e documents and views (we will handle paging later)
*
* @TODO: Paging
*
*/
var Couchdb = function(config){
        var ldbs 	= [] ;
	this.config	= config;
...
//            namespace = 'find'
	    host = config['host'] ;//CONFIG.couchdb['host']
